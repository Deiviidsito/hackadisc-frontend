export default {
  ...
  capinAi: {
    ...
    features: {
      learning: {
        ...
        description: 'Capin mejora sus predicciones con cada nuevo dato'
      },
      predictions: {
        title: 'Predicciones Precisas',
        description: '94.2% de precisión en estimaciones de pago'
      },
      analysis: {
        title: 'Análisis Inteligente',
        description: 'Identifica patrones complejos en comportamientos'
      },
      segmentation: {
        title: 'Segmentación Avanzada',
        description: 'Clasifica clientes por riesgo de retraso'
      }
    }
  },
  ...
  // Analytics Section
  analytics: {
    title: 'Tecnologías del Hackathon',
    subtitle: 'Stack tecnológico desarrollado específicamente para el desafío INSECAP'
  },
  ...
  // Footer
  footer: {
    platform: 'Capin Analytics Platform',
    copyright: '© 2025 Hackathon INSECAP • Desarrollado por Equipo .env.idia'
  }
}
